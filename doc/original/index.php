...
define('CAMPAIGN_ID', "XXX");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'XXX');
define('MP_PARAM_NAME', '_hfsess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', 'XXX');
define('CHECK_MCPROXY_VALUE', 'XXX');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '13997.3');
